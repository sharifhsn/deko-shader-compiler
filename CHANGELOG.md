...
- Recognize `break` and `continue` through nested lexical blocks, while rejecting
  side-effecting conditional-break prefixes until their exit liveness can be proven.
