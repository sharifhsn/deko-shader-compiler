...
use crate::bindings::*;
use crate::ir::{
    MeshShaderInfo, ShaderInfo, ShaderIoInfo, ShaderModel, ShaderModelInfo, ShaderStageInfo,
    VtgIoInfo,
};
use bitview::{BitMutView, BitMutViewable, BitView, BitViewable, SetBit, SetField};
use std::ops::Range;

// Public SPHv3 bit ranges and values from NVIDIA's MIT-licensed cla097sph.h.
const SPHV3_T1_SPH_TYPE: Range<usize> = 0..5;
const SPHV3_T1_SPH_TYPE_TYPE_01_VTG: u32 = 1;
const SPHV3_T1_SPH_TYPE_TYPE_02_PS: u32 = 2;
const SPHV3_T1_VERSION: Range<usize> = 5..10;
const SPHV3_T1_SHADER_TYPE: Range<usize> = 10..14;
const SPHV3_T1_SHADER_TYPE_VERTEX: u32 = 1;
const SPHV3_T1_SHADER_TYPE_TESSELLATION_INIT: u32 = 2;
const SPHV3_T1_SHADER_TYPE_TESSELLATION: u32 = 3;
const SPHV3_T1_SHADER_TYPE_GEOMETRY: u32 = 4;
const SPHV3_T1_SHADER_TYPE_PIXEL: u32 = 5;
const SPHV3_T1_MRT_ENABLE: Range<usize> = 14..15;
const SPHV3_T1_KILLS_PIXELS: Range<usize> = 15..16;
const SPHV3_T1_DOES_GLOBAL_STORE: Range<usize> = 16..17;
const SPHV3_T1_SASS_VERSION: Range<usize> = 17..21;
const SPHV3_T1_DOES_LOAD_OR_STORE: Range<usize> = 26..27;
const SPHV3_T1_DOES_FP64: Range<usize> = 27..28;
const SPHV3_T1_STREAM_OUT_MASK: Range<usize> = 28..32;
const SPHV3_T1_SHADER_LOCAL_MEMORY_LOW_SIZE: Range<usize> = 32..56;
const SPHV3_T1_PER_PATCH_ATTRIBUTE_COUNT: Range<usize> = 56..64;
const SPHV3_T1_SHADER_LOCAL_MEMORY_HIGH_SIZE: Range<usize> = 64..88;
const SPHV3_T1_THREADS_PER_INPUT_PRIMITIVE: Range<usize> = 88..96;
const SPHV3_T1_SHADER_LOCAL_MEMORY_CRS_SIZE: Range<usize> = 96..120;
const SPHV3_T1_OUTPUT_TOPOLOGY: Range<usize> = 120..124;
const SPHV3_T1_OUTPUT_TOPOLOGY_POINTLIST: u32 = 1;
const SPHV3_T1_OUTPUT_TOPOLOGY_LINESTRIP: u32 = 6;
const SPHV3_T1_OUTPUT_TOPOLOGY_TRIANGLESTRIP: u32 = 7;
const SPHV3_T1_RESERVED_COMMON_B: Range<usize> = 124..128;
const SPHV3_T1_MAX_OUTPUT_VERTEX_COUNT: Range<usize> = 128..140;
const SPHV3_T1_STORE_REQ_START: Range<usize> = 140..148;
const SPHV3_T1_STORE_REQ_END: Range<usize> = 152..160;
const SPHV3_T2_OMAP_SAMPLE_MASK: Range<usize> = 608..609;
const SPHV3_T2_OMAP_DEPTH: Range<usize> = 609..610;
...
impl From<&ShaderStageInfo> for ShaderType {
    fn from(value: &ShaderStageInfo) -> Self {
        match value {
            ShaderStageInfo::Vertex(_) | ShaderStageInfo::Task(_) => ShaderType::Vertex,
            ShaderStageInfo::Fragment(_) => ShaderType::Fragment,
            ShaderStageInfo::Geometry(_) => ShaderType::Geometry,
            ShaderStageInfo::TessellationInit(_) => ShaderType::TessellationInit,
...
pub fn encode_header(
    ...
    sph.set_does_load_or_store(shader_info.uses_global_mem || (sm.is_kepler() && slm_size > 0));
